...
const (
	mainRTPPercentage = 0.77

	lowRTPBase  = 44.223671
	highRTPBase = 80.2390
...
var (
	baseLowBonusRate  = 407.8968837
	baseHighBonusRate = 211.7836418

	baseLow4ScatterCount = 23138.0
	baseLow5ScatterCount = 1352.0
	baseLow6ScatterCount = 26.0

	baseHigh4ScatterCount = 44058.0
	baseHigh5ScatterCount = 3075.0
	baseHigh6ScatterCount = 85.0
	// ------------------------------------------------
...
var reelSet1 = [][]int{
	{7, 8, 4, 8, 12, 8, 8, 9, 6, 8, 2, 3, 6, 6, 8, 4, 6, 8, 9, 9, 9, 6, 10, 9, 9, 12, 6, 9, 9, 9, 10, 10, 6, 7, 1, 10, 6, 7, 10, 6, 10, 9, 10, 10, 9, 12, 7, 9, 5, 7, 10, 9, 2, 2, 9, 8, 10, 8, 7, 10, 12, 5, 10, 8, 10, 4, 10, 10, 7, 8, 9, 2, 3, 8, 10, 3, 10, 12, 3, 4, 8, 5, 5, 4, 5, 10, 10, 5, 8, 5, 9, 11, 8, 8, 3, 5, 8, 8, 7, 7},
